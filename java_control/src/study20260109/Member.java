...
/*
 ...
 static
   ...
   static변수와 static메서드가 있다.
   static 메서드에서는 static변수만 사용가능
          인스턴스 변수는 사용불가
   모든 객체가 공유해야하는 데이터가 필요한 경우 이거나
  ...
  권한 설정 하는거, 변수, 메서드, 클래스, 인터페이스 등에 사용된다.
       ...
       default
           기본적으로 붙은 접근제어자
           default 제어자가붙으면 같은 패키지에서만 사용 가능
