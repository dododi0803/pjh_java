...
//		int[]arr = new int[5];
		// arr 은 참조변수이다. 참조 변수는 메모리주소를 저장할수 있는 변수이다.
		// 배열의 인덱스는 0부터 시작이다.
...
//		String name = "김가은-김지은-강수정-박주희-박하니-최보라-서미나";
//		System.out.println(name);
//		
//		String[]names = name.split("-");
...
//		}
//		
//		for(int num : arr) { // 항상된 for문 (배열 전용 for문)
...
/*
     배열 - 동일한 데이터 타입의 데이터 저장공간이 연속적으로 나열되어있는 구조
